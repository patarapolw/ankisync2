...
class Fields(BaseModel):
    ntid = pv.ForeignKeyField(Notetypes, column_name="ntid", backref="fields")
    ord = pv.IntegerField()
    name = pv.TextField(collation="UNICASE")
    config = pv.BlobField()
...
class Notes(BaseModel):
    ...
    mid = pv.ForeignKeyField(Notetypes, column_name="mid", backref="notes")
    mod = pv.IntegerField()  # autogenerated
    usn = pv.IntegerField(default=-1)
...
class Templates(BaseModel):
    ntid = pv.ForeignKeyField(Notetypes, column_name="ntid", backref="templates")
...
class Cards(BaseModel):
    ...
    # Use auto-increment instead of time in Epoch seconds to ensure uniqueness
    id = pv.AutoField()
    nid = pv.ForeignKeyField(Notes, column_name="nid", backref="cards")
    did = pv.ForeignKeyField(Decks, column_name="did", backref="cards")
    ord = pv.IntegerField()
    mod = pv.IntegerField()  # autogenerated
    usn = pv.IntegerField(default=-1)
...
class Revlog(BaseModel):
    ...
    id = pv.AutoField()
    cid = pv.ForeignKeyField(Cards, column_name="cid", backref="revlogs")
    usn = pv.IntegerField(default=-1)
