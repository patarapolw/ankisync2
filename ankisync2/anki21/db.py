...
class Fields(BaseModel):
    ntid = pv.ForeignKeyField(Notetypes, column_name="ntid")
    ord = pv.IntegerField()
    name = pv.TextField(collation="UNICASE")
    config = pv.BlobField()
...
class Notes(BaseModel):
    ...
    mid = pv.ForeignKeyField(Notetypes, column_name="mid")
    mod = pv.IntegerField()  # autogenerated
    usn = pv.IntegerField(default=-1)
...
class Cards(BaseModel):
    ...
    # Use auto-increment instead of time in Epoch seconds to ensure uniqueness
    id = pv.AutoField()
    nid = pv.ForeignKeyField(Notes, column_name="nid")
    did = pv.ForeignKeyField(Decks, column_name="did")
    ord = pv.IntegerField()
    mod = pv.IntegerField()  # autogenerated
    usn = pv.IntegerField(default=-1)
...
class Revlog(BaseModel):
    ...
    id = pv.AutoField()
    cid = pv.ForeignKeyField(Cards, column_name="cid")
    usn = pv.IntegerField(default=-1)
